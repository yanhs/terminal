...
if tmux has-session -t "$SESSION" 2>/dev/null; then
  ...
  exec tmux new-session -s "$SESSION" -c /home/ubuntu/pr \; \
    set mouse on \; \
    send-keys "node /home/ubuntu/pr/OpenOrchestra/dist/entry.js tui --token 50999ba03c0451cc952c9c4fa3b05ae409030df4faf788bf --session claw-9" Enter
fi
